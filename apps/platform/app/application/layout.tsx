...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: `Application — ${tenant.name}`,
    description: `Complete your application for ${tenant.name} programs.`,
  };
}

/**
 * Minimal public layout for the application form.
 * No sidebar, no dashboard chrome — just brand header + form.
 */
